...
public class Utilities {
	...
	//generates a random int within range, bound exclusive
	public static int nextInt(int bound) {
		return gen.nextInt(bound);
	}

	public static int randInt(int lowerLimit, int upperLimit) {
		return gen.nextInt(upperLimit-lowerLimit)+lowerLimit;
	}

	//same as above but for double
	public static double nextDouble(double rangeMin, double rangeMax) {
		return rangeMin + (rangeMax - rangeMin) * gen.nextDouble();
	}
	
	//same as above but for float
	public static float nextFloat(float rangeMin, float rangeMax) {
		return rangeMin + (rangeMax - rangeMin) * gen.nextFloat();
	}
